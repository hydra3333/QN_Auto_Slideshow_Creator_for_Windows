...
def load_settings():	
	...
	TARGET_AUDIO_BACKGROUND_GAIN_DURING_OVERLAY		= int(-24)		# reduce audio of background music during overlay of snippet audio by xxDB
	...
	if not os.path.exists(SLIDESHOW_SETTINGS_MODULE_FILENAME):
		...
		specially_formatted_settings_list =	[
										...
										[ 'TEMP_FOLDER',								TEMP_FOLDER,								r'folder where temporary files go; USE A DISK WITH LOTS OF SPARE DISK SPACE - CIRCA 500 Mb PER 100 PICS/VIDEOS' ],
