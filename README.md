...
- see other settings in `separate_slideshows_for_each_folder_in_a_top_folder.bat`, you can edit them ... careful to ensure syntax is EXACT and precisely maintained
